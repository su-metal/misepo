      ...
      >
        ...
        <div className="p-8 text-center">
          ...
          <div className="space-y-3">
            <button
              onClick={onLogin}
              className="w-full py-4 md:py-3 px-4 bg-[#06C755] hover:bg-[#05b54d] text-white font-bold rounded-xl flex items-center justify-center gap-3 transition-colors shadow-sm text-lg md:text-base"
            >
