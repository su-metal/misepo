...
const HistorySidebar: React.FC<HistorySidebarProps> = ({ history, isPro, isLoggedIn, onSelect, isOpen, toggleOpen, onOpenLogin, onOpenUpgrade }) => {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed md:relative top-0 left-0 h-full bg-white/90 backdrop-blur-xl md:bg-white border-r border-gray-100 w-72 transform transition-transform duration-300 ease-out z-50 flex flex-col shadow-2xl md:shadow-none ${
