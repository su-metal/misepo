...
1. **文脈の言い換え（脱オウム返し）**: 口コミのキーワードを機械的に繰り返すのではなく、**文脈に合わせてプロらしく言い換えて**ください。
   ...
   - **注意**: 「お店が忙しい（行列）」を「（お客様の）お忙しい時間」と取り違えないこと。また、お客様自身が待っていない場合（「帰る頃には並んでいた」等）は謝罪せず、「多くの方にご来店いただいている状況をご覧になり…」と状況の共有として受け止めてください。
2. **客観性と過剰謝罪の防止**: 
   - お客様の主観的な褒め言葉（「奥深い味」「分厚い」等）を、そのまま自分の言葉として「当店の奥深い味は…」と返すと傲慢に聞こえます。「〜とのお言葉、光栄です」「〜を楽しんでいただけて」と受け止める形式にしてください。
