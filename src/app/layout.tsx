    ...
    <html lang="ja">
      ...
      <body className="relative">
        ...
        <div className="fixed inset-0 -z-50 overflow-hidden pointer-events-none select-none bg-studio-stage">
          ...
          {/* Dynamic Glow Orbs */}
          <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] bg-gradient-to-br from-[#80CAFF]/20 to-transparent rounded-full blur-[120px] animate-pulse-slow" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] bg-gradient-to-br from-[#F87171]/10 to-transparent rounded-full blur-[100px] animate-pulse-slow" style={{ animationDelay: '1s' }} />
          <div className="absolute top-[20%] right-[10%] w-[30vw] h-[30vw] bg-gradient-to-br from-[#C084FC]/15 to-transparent rounded-full blur-[80px] animate-pulse-slow" style={{ animationDelay: '2s' }} />
