...
const GuideModal: React.FC<GuideModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-0 md:p-6 bg-slate-900/40 backdrop-blur-sm animate-in fade-in duration-500" onClick={onClose}>
      ...
      >
        {/* Header */}
        <div className="p-6 md:p-8 border-b-[3px] flex items-center justify-between sticky top-0 z-20 bg-[var(--bg-beige)] border-black">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center transition-all bg-[var(--lavender)] text-black border-2 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)]">
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 flex items-center justify-center rounded-xl transition-all active:scale-95 bg-white border-2 border-transparent hover:border-black text-slate-400 hover:text-black hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)]"
          >
        ...
        <div className="overflow-y-auto overscroll-contain flex-1 p-6 md:p-10 space-y-12 bg-white">
          ...
          <div className="pt-8 pb-4 text-center">
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-12 py-4 font-black text-sm transition-all active:scale-95 rounded-xl bg-black text-white border-2 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:bg-slate-800 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_rgba(0,0,0,1)]"
            >
              理解した
            </button>
          </div>
