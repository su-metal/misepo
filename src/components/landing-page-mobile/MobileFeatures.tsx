        ...
        <section className="space-y-6 mb-6">
            <div className="bg-white rounded-3xl p-6 shadow-sm">
                <h3 className="font-bold text-slate-800 text-lg mb-6 text-center">
                    <span className="block text-xs text-[var(--ichizen-green)] tracking-widest uppercase mb-2">Why MisePo?</span>
                    選ばれる3つの理由
                </h3>
                ...
                <div className="space-y-6">
                    ...
                    <div className="text-center">
                        <div className="w-12 h-12 mx-auto bg-[var(--ichizen-blue)]/10 rounded-2xl flex items-center justify-center text-[var(--ichizen-blue)] mb-3">
                            <Icons.Users size={24} />
                        </div>
                        <h4 className="font-bold text-slate-800 mb-2">採用率 1.8倍</h4>
                    ...
                    {/* Feature 2 */}
                    <div className="text-center">
                        <div className="w-12 h-12 mx-auto bg-[var(--ichizen-green)]/10 rounded-2xl flex items-center justify-center text-[var(--ichizen-green)] mb-3">
                            <Icons.ShieldCheck size={24} />
                        </div>
                        <h4 className="font-bold text-slate-800 mb-2">信頼の獲得</h4>
                        <p className="text-xs text-slate-500 leading-relaxed">
                            丁寧なクチコミ返信で、<br />
                            お客様からの信頼度が劇的に向上。
                        </p>
                    ...
                    {/* Feature 3 */}
                    <div className="text-center">
                        <div className="w-12 h-12 mx-auto bg-[#F5CC6D]/10 rounded-2xl flex items-center justify-center text-[#F5CC6D] mb-3">
                            <Icons.Zap size={24} />
                        </div>
                        <h4 className="font-bold text-slate-800 mb-2">圧倒的時短</h4>
                        <p className="text-xs text-slate-500 leading-relaxed">
                            投稿作成にかかる時間は約30秒。<br />
                            もう、閉店後に残る必要はありません。
                        </p>
