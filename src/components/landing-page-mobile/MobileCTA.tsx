...
export const MobileCTA = () => {
    return (
        <section className="bg-[#1f29fc] rounded-3xl p-8 text-center text-white shadow-lg mb-20 relative overflow-hidden">
            {/* Decorative circles */}
            ...
            <div className="relative z-10">
                ...
                <button onClick={() => window.location.href = '/start'} className="w-full py-4 bg-white text-[#1f29fc] font-bold rounded-xl shadow-xl flex items-center justify-center gap-2 active:scale-95 transition-transform group relative overflow-hidden">
