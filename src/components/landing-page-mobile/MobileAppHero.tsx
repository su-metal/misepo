    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-between py-12 px-6">
            ...
            <div className="text-center">
                <h2 className="text-[#0071b9] font-bold text-sm tracking-wide mb-2">
                    AIなのに、あなたの言葉
                </h2>
            </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center space-y-8">
                ...
                <div className="relative">
                    <svg width="200" height="80" viewBox="0 0 200 80" className="text-[#0071b9]">
                        <path
                    ...
                    <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 text-2xl font-black text-[#0071b9] tracking-tight" style={{ fontFamily: 'cursive' }}>
                        MisePo
                    </div>
                </div>
