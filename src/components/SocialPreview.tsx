...
const SocialPreview: React.FC<SocialPreviewProps> = ({ platform, text, storeName }) => {
  ...
  if (platform === Platform.X) {
    return (
      <div className="bg-white border border-gray-100 rounded-xl overflow-hidden w-full max-w-md mx-auto font-sans text-[15px] leading-normal text-slate-900 shadow-sm">
        <div className="p-4 flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 text-[15px]">
              ...
              <span className="text-slate-500 truncate">@{storeName.replace(/\s+/g, '').toLowerCase()}</span>
              <span className="text-slate-500">·</span>
              <span className="text-slate-500">1m</span>
            </div>
            <div className="mt-0.5 whitespace-pre-wrap break-words text-slate-900">
              {/* Hashtags in blue */}
            ...
            {/* Actions Mockup */}
            <div className="flex justify-between mt-3 max-w-[80%] text-slate-500">
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden w-full max-w-sm mx-auto font-sans text-sm shadow-sm">
        ...
        <div className="flex items-center justify-between p-2.5 border-b border-gray-50">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-xs text-slate-900">{storeName}</span>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-900"><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>
        </div>
        ...
        <div className="p-3">
          ...
          <div className="font-semibold text-xs mb-2 text-slate-900">128 likes</div>
          
          {/* Caption */}
          <div className="text-sm whitespace-pre-wrap break-words text-slate-900 leading-relaxed">
          ...
          <div className="text-[10px] text-slate-400 mt-2 uppercase tracking-wide">2 HOURS AGO</div>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 w-full max-w-md mx-auto font-sans shadow-sm">
        <div className="flex gap-3">
          ...
          <div className="flex-1">
             <div className="text-xs font-medium text-slate-500 mb-0.5">{storeName}</div>
             <div className="text-[10px] text-slate-400 mb-2">a week ago</div>
