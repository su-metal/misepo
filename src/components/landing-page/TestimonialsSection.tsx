        ...
        <section className="py-24 bg-[#f9f5f2] relative overflow-hidden border-b-[6px] border-black">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-20">
                    <span className="inline-block px-4 py-2 bg-[#9B98C2] text-white border-[3px] border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-2xl text-xs font-black uppercase tracking-widest mb-6 block w-fit mx-auto -rotate-1">User Voices</span>
                ...
                <div className="grid md:grid-cols-2 gap-10">
                    <div className="bg-white border-[4px] border-black rounded-2xl p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                        <div className="absolute -top-5 -right-5 bg-[#E5C58C] border-[3px] border-black rounded-2xl p-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rotate-6">
                        ...
                        <p className="text-black text-xl font-black leading-relaxed mb-10 italic">
                            「AI特有の堅苦しさがなくて、<span className="bg-[#D4849A] text-white px-2 py-0.5 not-italic">常連さんからも『最近の投稿、楽しそうですね』と声をかけられました</span>。」
                        </p>
                    ...
                    <div className="bg-white border-[4px] border-black rounded-2xl p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                        <div className="absolute -top-5 -right-5 bg-[#88B0A5] border-[3px] border-black rounded-2xl p-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] -rotate-6">
                        ...
                        <p className="text-black text-xl font-black leading-relaxed mb-10 italic">
                            「スタッフ数人で運用していますが、<span className="bg-[#88B0A5] text-white px-2 py-0.5 not-italic">誰が書いても『お店のトーン』が揃うのが安心</span>。任せられるようになりました。」
                        </p>
                        <div className="flex items-center gap-5 border-t-[3px] border-black pt-8">
