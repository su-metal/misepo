        ...
        <>
            ...
            <section className="py-20 md:py-32 bg-[#f9f5f2] relative overflow-hidden border-b-[6px] border-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-20">
                        <span className="bg-[#D4849A] text-white font-black tracking-tight text-sm uppercase mb-6 px-4 py-2 border-[3px] border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-2xl inline-block">Why MisePo?</span>
                        <h2 className="text-4xl md:text-7xl font-black text-black mb-8 tracking-tight leading-tight">
                            なぜ今、<br className="md:hidden" /><span className="underline decoration-[6px] decoration-[#D4849A]">MisePo（分身）</span>が<br className="md:hidden" />必要なのか？
                        </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                        ...
                        <div className="bg-white border-[4px] border-black rounded-2xl p-8 relative shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-14 h-14 bg-[#E5C58C] border-[3px] border-black rounded-2xl flex items-center justify-center shrink-0 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] group-hover:rotate-6 transition-transform">
                            ...
                            <p className="text-black font-bold text-lg leading-relaxed">
                                若者の85%は、バイト応募前に店主の<span className="bg-[#E5C58C] px-1 border-b-[2px] border-black">SNSで職場の雰囲気</span>をチェックしています。
                            </p>
                        </div>
                        ...
                        <div className="bg-white border-[4px] border-black rounded-2xl p-8 relative shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-14 h-14 bg-[#88B0A5] border-[3px] border-black rounded-2xl flex items-center justify-center shrink-0 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] group-hover:-rotate-6 transition-transform">
                            ...
                            <p className="text-black font-bold text-lg leading-relaxed">
                                クチコミに丁寧に返信している店は、そうでない店より<span className="bg-[#88B0A5] text-white px-1 border-b-[2px] border-black">顧客の信頼度</span>が圧倒的に高まります。
                            </p>
                        </div>
                        ...
                        <div className="bg-white border-[4px] border-black rounded-2xl p-8 relative shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all">
                            <div className="flex items-center gap-4 mb-8">
                                <div className="w-14 h-14 bg-[#9B98C2] border-[3px] border-black rounded-2xl flex items-center justify-center shrink-0 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] group-hover:scale-110 transition-transform">
                            ...
                            <div className="flex items-baseline gap-2 mb-6 text-[#D4849A]">
                                <span className="text-5xl font-black tabular-nums">2人に1人</span>
                            </div>
                            <p className="text-black font-bold text-lg leading-relaxed">
                                <span className="bg-[#9B98C2] text-white px-1 border-b-[2px] border-black">最新情報が不明な店</span>への来店を断念した経験があります。
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="solution" className="py-20 md:py-32 bg-black text-white overflow-hidden relative border-b-[6px] border-white">
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
                    <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-[#D4849A] rounded-full blur-[120px]" />
                    <div className="absolute bottom-[-10%] left-[-5%] w-[600px] h-[600px] bg-[#88B0A5] rounded-full blur-[120px]" />
                </div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-24">
                        <span className="bg-[#88B0A5] text-white font-black tracking-tight text-sm uppercase mb-6 px-4 py-2 border-[3px] border-white rounded-2xl shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] inline-block">Solution</span>
                        <h2 className="text-4xl md:text-7xl font-black mb-10 tracking-tight leading-tight">
                            AIが、<br className="md:hidden" /><span className="bg-[#D4849A] px-4 py-1 inline-block -rotate-1 border-[3px] border-white rounded-2xl shadow-[6px_6px_0px_0px_rgba(255,255,255,1)]">あなたの『分身』</span><br className="md:hidden" />になる。
                        </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto mb-32">
                        ...
                        <div className="bg-black border-[3px] border-white rounded-2xl p-8 relative shadow-[8px_8px_0px_0px_rgba(255,255,255,0.2)] group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,0.3)] transition-all">
                            <div className="flex flex-col items-start gap-6">
                                <div className="w-14 h-14 bg-[#88B0A5] border-[3px] border-white rounded-2xl flex items-center justify-center text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] group-hover:scale-110 transition-transform">
                                    <Icons.Bot size={28} />
                                </div>
                                <div className="space-y-3">
                                    <div className="inline-block px-4 py-1 bg-[#88B0A5] text-white text-xs font-black uppercase border-[2px] border-white rounded-2xl">Step 1</div>
                                    <h3 className="text-2xl font-black text-white">あなたの『書き癖』を学習</h3>
                                </div>
                            </div>
                            <p className="text-white/70 leading-relaxed mt-6 font-bold">
                                過去の投稿の<span className="text-[#88B0A5] underline decoration-2">スクショをアップロードするだけ</span>。<br />
                        ...
                        <div className="bg-black border-[3px] border-white rounded-2xl p-8 relative shadow-[8px_8px_0px_0px_rgba(255,255,255,0.2)] group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,0.3)] transition-all">
                            <div className="flex flex-col items-start gap-6">
                                <div className="w-14 h-14 bg-[#D4849A] border-[3px] border-white rounded-2xl flex items-center justify-center text-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] group-hover:-rotate-6 transition-transform">
                                    <Icons.Users size={28} />
                                </div>
                                <div className="space-y-3">
                                    <div className="inline-block px-4 py-1 bg-[#D4849A] text-white text-xs font-black uppercase border-[2px] border-white rounded-2xl">Step 2</div>
                                    <h3 className="text-2xl font-black text-white">「中の人」を自由自在に</h3>
                                </div>
                            </div>
                            <p className="text-white/70 leading-relaxed mt-6 font-bold">
                                「熱い店長」「親しみやすい看板娘」など、投稿の目的に合わせて<span className="text-[#D4849A] underline decoration-2">人格を切り替え</span>。
                        ...
                        <div className="bg-black border-[3px] border-white rounded-2xl p-8 relative shadow-[8px_8px_0px_0px_rgba(255,255,255,0.2)] group hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,0.3)] transition-all">
                            <div className="flex flex-col items-start gap-6">
                                <div className="w-14 h-14 bg-[#E5C58C] border-[3px] border-white rounded-2xl flex items-center justify-center text-black shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] group-hover:rotate-6 transition-transform">
                                    <Icons.Heart size={28} />
                                </div>
                                <div className="space-y-3">
                                    <div className="inline-block px-4 py-1 bg-[#E5C58C] text-black text-xs font-black uppercase border-[2px] border-white rounded-2xl">Result</div>
                                    <h3 className="text-2xl font-black text-white">投稿作業を5秒で完結</h3>
                                </div>
                            </div>
                            <p className="text-white/70 leading-relaxed mt-6 font-bold">
                                生成された文章はタップ一つで<span className="text-[#E5C58C] underline decoration-2">自動コピー</span>。
                    ...
                    <div className="max-w-5xl mx-auto bg-white border-[4px] border-white rounded-2xl p-6 md:p-12 relative shadow-[10px_10px_0px_0px_rgba(255,255,255,0.1)]">
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-10 relative">
                                ...
                                {/* MisePo */}
                                <div className="bg-[#D4849A] border-[4px] border-white rounded-2xl p-8 relative shadow-[10px_10px_0px_0px_rgba(255,255,255,0.2)]">
                                    <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div className="bg-white text-black border-[3px] border-black rounded-2xl p-6 relative shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
                                        ...
                                        <p className="leading-relaxed font-black text-lg italic">
                                            お待たせしました🍓<br />
                                            明日から<span className="bg-[#E5C58C] px-1 border-b-[3px] border-black">地元の完熟いちご</span>をたっぷり使ったパフェが始まります！<br />
                    ...
                    <div className="mt-24 text-center">
                        <div className="inline-flex items-center gap-4 bg-[#88B0A5] text-white px-8 py-4 border-[4px] border-white rounded-2xl shadow-[8px_8px_0px_0px_rgba(255,255,255,0.2)] rotate-1 group hover:rotate-0 transition-transform cursor-default">
