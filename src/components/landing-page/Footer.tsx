...
export const Footer = () => {
    return (
        <footer className="bg-[#f0eae4] text-[#282d32] py-24 md:py-48 overflow-hidden border-t border-slate-200">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-24 mb-24 items-end">
                    <div className="flex flex-col items-start">
                        <h2 className="text-6xl md:text-8xl font-black tracking-tighter mb-12">ミセポ</h2>
                    ...
                    <div className="grid grid-cols-2 gap-12 text-left">
                        ...
                        <div className="space-y-6">
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Legal</span>
                            <ul className="space-y-4 text-lg font-bold">
                ...
                <div className="pt-24 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-8">
                    <p className="text-sm font-bold text-slate-400 tracking-widest">© {new Date().getFullYear()} MISEPO INC.</p>
                    <div className="flex gap-8 text-[10px] font-black tracking-[0.4em] text-slate-400 uppercase">
                        <span>TOKYO</span>
                        <span>SASEBO</span>
                        <span>AI NATIVE</span>
                    </div>
