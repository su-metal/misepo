  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-stone-900/60 backdrop-blur-sm animate-in fade-in duration-500">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden relative text-center p-8 animate-in zoom-in-95 slide-in-from-bottom-4 duration-500 delay-100">
        ...
        <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-purple-600 text-white rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-orange-200 rotate-3">
        ...
        <button
          onClick={onClose}
          className="w-full py-4.5 md:py-3.5 bg-stone-900 hover:bg-stone-800 text-white font-bold rounded-xl shadow-xl transition-all transform hover:-transtone-y-0.5 active:transtone-y-0 text-lg md:text-base"
        >
          デモを試す
        </button>
