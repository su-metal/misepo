    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-0 bg-gray-50 max-h-[80vh] overflow-y-auto">
                        ...
                        {platform === Platform.GoogleMaps && (
                            <div className="w-full bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden max-w-[370px]">
                                ...
                                <div className="px-4 pb-4">
                                    ...
                                    <div className="mt-4">
                                        <button className="px-5 py-2 bg-blue-50 text-blue-700 text-sm font-medium rounded-full hover:bg-blue-100 transition-colors">
                                            Learn more
                                        </button>
                                    </div>
                                </div>
