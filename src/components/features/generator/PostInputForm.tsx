            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-1 px-4 pt-4 pb-2 bg-gray-50/50">
                <div className="flex items-stretch gap-1 flex-1">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-t-xl text-sm font-bold transition-all relative ${platforms.includes(Platform.X)
                    ...
                    >
                        ...
                        <span>X (Twitter)</span>
                        {platforms.includes(Platform.X) && <div className="absolute top-0 left-0 right-0 h-0.5 bg-[#4f46e5] rounded-t-xl" />}
                    </button>
                    <button
                        onClick={() => onSetActivePlatform(Platform.Instagram)}
                        className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-t-xl text-sm font-bold transition-all relative ${platforms.includes(Platform.Instagram)
                    ...
                    >
                        ...
                        <span>Instagram</span>
                        {platforms.includes(Platform.Instagram) && <div className="absolute top-0 left-0 right-0 h-0.5 bg-pink-500 rounded-t-xl" />}
                    </button>
                    <button
                        onClick={() => onSetActivePlatform(Platform.GoogleMaps)}
                        className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-t-xl text-sm font-bold transition-all relative ${platforms.includes(Platform.GoogleMaps)
                    ...
                    >
                        ...
                        {platforms.includes(Platform.GoogleMaps) && <div className="absolute top-0 left-0 right-0 h-0.5 bg-green-500 rounded-t-xl" />}
                    </button>
                </div>
