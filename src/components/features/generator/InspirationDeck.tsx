        ...
        return (
            <div className="w-full h-32 flex items-center justify-center bg-stone-50/50 rounded-2xl mb-4 border border-stone-100/50">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-[9px] font-black text-[#0071b9]/50 tracking-widest uppercase">Sommelier is thinking...</span>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="mb-6 animate-in slide-in-from-right-4 duration-700 fade-in">
            <div className="flex items-center justify-between px-1 mb-2">
                ...
                >
                    <RotateCcwIcon className="w-3 h-3 text-slate-500 group-hover:text-[#0071b9] transition-colors" />
                ...
                <div className="grid grid-rows-2 grid-flow-col gap-2">
                    {cards.map((card) => (
                        <button
                            ...
                            className="flex items-center gap-2.5 px-5 py-3 bg-white rounded-full border border-stone-100 shadow-sm transition-all hover:scale-[1.02] active:scale-95 hover:border-[#0071b9]/30 group shrink-0 whitespace-nowrap"
                        >
                            <span className="text-xl leading-none">{card.icon}</span>
                            <div className="flex flex-col items-start leading-tight">
                                <h4 className="text-[13px] font-bold text-[#111111] group-hover:text-[#0071b9] transition-colors">{card.title}</h4>
