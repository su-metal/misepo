                    ...
                    return (
                        <button
                            ...
                            className={`
                                ...
                                ${isSelected
                                    ? `border-[3px] border-black text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] bg-gradient-to-br from-[#6366F1] to-[#A855F7] hover:translate-x-[-2px] hover:translate-y-[-2px]`
