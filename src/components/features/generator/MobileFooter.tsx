...
export const MobileFooter: React.FC<MobileFooterProps> = ({
    ...
    return (
        <div className={`fixed bottom-8 sm:absolute sm:bottom-8 left-0 right-0 z-[150] px-4 bg-transparent transition-all duration-500 pb-safe ${isDrawerOpen ? 'opacity-0 translate-y-20 pointer-events-none' : 'opacity-100 translate-y-0 pointer-events-auto'}`}>
            <div className="relative w-full h-[84px] pointer-events-auto">
                ...
                <button
                    ...
                    className={`
                        ...
                        ${isConfirmStep
                            ? 'bg-[#f2e018] border-white text-black rotate-0 scale-110'
                            : 'bg-[#f2e018] border-white text-black rotate-180 scale-100 hover:scale-105'
                        }
                    `}
