            ...
            <div className="relative w-full h-[84px] pointer-events-auto">
                ...
                <button
                    ...
                    className={`
                        ...
                        transition-all duration-300 border-[4px] border-white
                        ${isConfirmStep
                            ? 'bg-[#2b2b2f] text-white rotate-0 scale-110 shadow-xl'
                            : 'bg-[#2b2b2f] text-white rotate-180 scale-100 hover:scale-105 shadow-xl'
                        }
                    `}
