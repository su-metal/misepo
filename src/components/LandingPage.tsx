...
export default function LandingPage() {
  ...
  const LeftPanelContent = (
    <div className="flex flex-col items-end text-right space-y-8 animate-fade-in-right">
      {/* Brand Logo */}
      <div className="mb-4">
        <span className="font-bold text-6xl tracking-tight italic text-[var(--ichizen-blue)]" style={{ fontFamily: 'cursive' }}>
          misepo
        </span>
      </div>

      <div className="space-y-2">
        <p className="text-sm font-bold tracking-widest uppercase text-[var(--ichizen-green)]">New Standard</p>
        <h1 className="text-4xl font-black text-[var(--ichizen-blue)] leading-tight">
          AIなのに、<br />
          あなたの言葉。
        </h1>
      </div>
  ...
  const RightPanelContent = (
    <div className="flex flex-col items-start space-y-8 animate-fade-in-left">
      ...
      <div className="space-y-4">
        <p className="text-sm font-bold text-[var(--ichizen-blue)]">アプリをダウンロード</p>
      ...
      <div className="pt-8 border-t border-[var(--ichizen-blue)]/10 w-full">
        <div className="flex gap-4">
          <a href="#" className="w-10 h-10 rounded-full border border-[var(--ichizen-blue)]/20 flex items-center justify-center text-[var(--ichizen-blue)] hover:bg-[var(--ichizen-blue)] hover:text-white transition-colors">
