...
export const LineIcon = ({ className = "w-4 h-4", textFill = "white", isActive = false, color = "currentColor" }: { className?: string, textFill?: string, isActive?: boolean, color?: string }) => (
